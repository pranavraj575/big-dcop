...
def run_global_dispatcher(pydcop_dict, yaml_filepath, output_json):
    ...
    cmd = [
        ...
        "--output", output_json,
        "solve", 
        "--algo", "regret_matching", 
        "--algo_param", "stop_cycle:50",
        "--algo_param", "rm_plus:1",
        "--algo_param", "update_prob:0.2",
        "--algo_param", "predictive:1",
        "--algo_param", "context_based:1",
        "--distribution", yaml_filepath,
        yaml_filepath
    ]
