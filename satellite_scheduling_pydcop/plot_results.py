...
if __name__ == "__main__":
    ...
    algorithm_dirs = [
        os.path.join(DIR, "satellite_scheduling_pydcop", "algo_configs/baseline_algorithm_configs.json"),
        os.path.join(DIR, "satellite_scheduling_pydcop", "algo_configs/rm_algorithm_configs.json"),
    ]
    alg_to_plot_params = dict()
